...
<html>
  ...
  <article class='prem-players'>
  <div class="ism">
    <div class="ismElementList">
      <h2>Goalkeepers</h2>
        <div class="ismLine">
          <div class="ismUnit ismSize1of2">
            <table class="ismTable ismPrintTable">
              <colgroup>
                  <col class="ismCol1">
                  <col class="ismCol2">
                  <col class="ismCol3">
              ...
              <tbody>
                ...
                <div class="ismUnit ismSize1of2 ismLastUnit">
                    <table class="ismTable ismPrintTable ismLastPrintTable">
                        <colgroup>
                            <col class="ismCol1">
                            <col class="ismCol2">
                            <col class="ismCol3">
